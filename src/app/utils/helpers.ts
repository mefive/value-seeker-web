...
export function makeQueryParams<Q extends {}, E extends Q, U extends keyof Q>(
  query: Q,
  exist: E,
  keys: U[],
): Pick<Q, U> {
...
>(
...
): { idTree: IdTreeNode[]; entities: Entities<T> } {
  ...
  if (nodes != null && nodes.length > 0) {
    ...
    walkTree(
      nodes,
      (node, parent, idTreeNode: IdTreeNode): IdTreeNode | boolean => {
